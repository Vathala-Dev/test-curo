...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Contact CuroAid to book home healthcare services. Call, email, or fill out our form to get a callback from our team.",
};
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 rounded-2xl border border-blue-100 bg-light-blue p-4 sm:p-6">
                ...
                <div className="flex items-start gap-4 rounded-2xl border border-blue-100 bg-light-blue p-6">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-primary text-white">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
